...
We will investigate whether the number of people that are fatally shot for a given race in our data is consistent with a population in which each person, regardless of race, is equally likely to be fatally shot. To do this, we will create 1000 samples of a population of 500000 people in the US based on [https://www.census.gov/quickfacts/fact/table/US/PST045219](2019 Census data)  regarding racial proportions.  The probability of getting fatally shot regardless of race is 1/315, according to [https://www.businessinsider.com/us-gun-death-murder-risk-statistics-2018-3](Business Insider).
